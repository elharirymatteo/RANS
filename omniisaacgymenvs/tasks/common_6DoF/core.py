...
from omniisaacgymenvs.tasks.common_3DoF.core import Core as Core2D
...
class Core(Core2D):
    ...
    def __init__(self, num_envs: int, device: str) -> None:
        ...
        self._dim_orientation = 6  # theta heading in the world frame (R[:2,:3]) [0:6]
