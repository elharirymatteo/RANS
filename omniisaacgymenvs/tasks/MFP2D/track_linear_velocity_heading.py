...
from omniisaacgymenvs.tasks.common_3DoF.task_rewards import (
    TrackLinearVelocityHeadingReward,
)
from omniisaacgymenvs.tasks.MFP2D.task_parameters import (
    TrackLinearVelocityHeadingParameters,
)
...
class TrackLinearVelocityHeadingTask(Core):
    """
    ...
    def __init__(
        ...
        super(TrackLinearVelocityHeadingTask, self).__init__(num_envs, device)
        # Task and reward parameters
        self._task_parameters = TrackLinearVelocityHeadingParameters(**task_param)
        self._reward_parameters = TrackLinearVelocityHeadingReward(**reward_param)
