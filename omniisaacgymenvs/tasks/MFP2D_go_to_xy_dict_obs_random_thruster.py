...
class MFP2DGoToXYDictRTTask(RLTask):
    def __init__(
        self,
    ...
    def pre_physics_step(self, actions: torch.Tensor) -> None:
        ...
        #print(self.current_transforms[0])
        #print(thrusts[0])
        #print(self.sorted_thruster_indices[0])
    ...
    def randomize_thruster_state(self, env_ids, num_envs):
        ...
        #print(selected_thrusters.shape, final_idx.shape, sorted_idx.shape)
        self.sorted_thruster_indices[env_ids] = torch.gather(selected_thrusters, 1, sorted_idx)#.to(self._device)
