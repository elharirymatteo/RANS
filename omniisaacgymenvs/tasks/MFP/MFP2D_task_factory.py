...
# from omniisaacgymenvs.tasks.MFP.MFP2D_go_through_pose_seq import GoThroughPoseSequenceTask
...
# task_factory.register("GoThroughXYSequence", GoThroughPoseSequenceTask)
