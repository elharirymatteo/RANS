...
class MFP2DGoToPoseCrippledTask(RLTask):
    def __init__(
        self,
    ...
    def get_observations(self) -> dict:
        ...
        # Thrusters state
        self.obs_buf[..., 20:20+self._num_actions] = self.thrusters_state
    ...
    def pre_physics_step(self, actions: torch.Tensor) -> None:
        ...
        # Applies the thrust multiplier & thrusters_state (mask)
    ...
    def reset_idx(self, env_ids):
        ...
        # Randomly kills one thruster for each platform
