...
class GoToPositionReward:
    """ "
    Reward function and parameters for the GoToPosition task."""
...
class TrackLinearVelocityReward:
    """
    Reward function and parameters for the TrackLinearVelocity task."""
...
class TrackLinearAngularVelocityReward:
    """
    Reward function and parameters for the TrackLinearAngularVelocity task."""
