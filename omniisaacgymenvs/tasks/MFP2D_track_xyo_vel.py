...
class MFP2DTrackXYOVelocityTask(RLTask):
    def __init__(
        self,
        ...
        self.omega_velocity_tolerance = self._task_cfg["env"]["task_parameters"]["OmegaVelocityTolerance"]
        self.kill_after_n_steps_in_tolerance = self._task_cfg["env"]["task_parameters"]["KillAfterNStepsInTolerance"]
        self._min_xy_velocity = self._task_cfg["env"]["task_parameters"]["MinXYVelocity"]
        self._max_xy_velocity = self._task_cfg["env"]["task_parameters"]["MaxXYVelocity"]
        self._min_omega_velocity = self._task_cfg["env"]["task_parameters"]["MinOmegaVelocity"]
        self._max_omega_velocity = self._task_cfg["env"]["task_parameters"]["MaxOmegaVelocity"]
        self._max_distance = self._task_cfg["env"]["task_parameters"]["MaxDistance"]
        self._reset_xy_error = self._task_cfg["env"]["task_parameters"]["ResetXYError"]
        self._reset_omega_error = self._task_cfg["env"]["task_parameters"]["ResetOmegaError"]
        # Rewards parameters
        self.rew_scales = {}
