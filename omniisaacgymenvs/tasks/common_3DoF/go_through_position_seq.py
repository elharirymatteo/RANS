...
from omniisaacgymenvs.tasks.common_3DoF.task_rewards import (
    GoThroughPositionSequenceReward,
)
from omniisaacgymenvs.tasks.common_3DoF.task_parameters import (
    GoThroughPositionSequenceParameters,
)
...
class GoThroughPositionSequenceTask(Core):
    """
    ...
    def __init__(
        ...
        super(GoThroughPositionSequenceTask, self).__init__(num_envs, device)
        # Task and reward parameters
        self._task_parameters = GoThroughPositionSequenceParameters(**task_param)
        self._reward_parameters = GoThroughPositionSequenceReward(**reward_param)
